...
public interface IProductsRepository
{
    ...
    /// <returns>Returns true or false if successful</returns>
    Task<bool> DeleteProduct(Guid productId);
    
    /// <summary>
    /// Updates an existing product asynchronously
    /// </summary>
    /// <param name="newProduct">The product to be updated</param>
    ...
    /// <summary>
    /// Retrieves a specific product based on the specified condition asynchronously
    /// </summary>
    /// <param name="conditionExpression">The condition to filter the product</param>
    /// <returns>Returns a single product that satisfies condition or null if none satisfies</returns>
    ...
    /// <returns>Returns products that satisfy condition</returns>
